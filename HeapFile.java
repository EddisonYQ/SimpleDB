...
public class HeapFile implements DbFile {
	...
	public Page readPage(PageId pid) {
		...
		try {
			...
			f.seek(pid.getPageNumber() * BufferPool.getPageSize());
			f.read(buffer);
			f.close();
	...
	public void writePage(Page page) throws IOException {
		...
		// required fro lab2
		/*
		 * check if page is dirty Open file with RandomAccessFile skipBy tes to the
	...
	public int numPages() {
		...
		// BufferPool.getPageSize() = 4096 
		int num = (int)(file.length() / 4096);
		return  num;
	...
	public DbFileIterator iterator(TransactionId tid) {
        ...
        return  new DbFileIter(new ArrayList<Tuple>());
